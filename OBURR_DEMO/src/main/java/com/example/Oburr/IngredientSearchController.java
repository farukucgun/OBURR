...
public class IngredientSearchController {
    ...
    void openRecipe(Event event) {
        ...
        if( h == hbox1 ){
            ...
            isSuitable = allRecipesResults.get(0).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(1).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(2).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(3).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(4).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(5).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(6).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(7).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(8).getRecipe().getIsSuitable();
            ...
            isSuitable = allRecipesResults.get(9).getRecipe().getIsSuitable();
        ...
        recipiePage.fromIngredientSearch(  );
